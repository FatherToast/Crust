...
public class CrustByteMode extends CrustMode<Byte> {
    ...
    public CrustByteMode( String id, int opLevel ) { super( id, opLevel ); }
    
    /** Creates a new auto-registered mode. */
    public CrustByteMode( String id, int opLevel, @Nullable ICommandHandler<Byte> validator ) { super( id, opLevel, validator ); }
