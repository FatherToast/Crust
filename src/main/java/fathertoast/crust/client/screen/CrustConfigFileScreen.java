...
public class CrustConfigFileScreen extends Screen {
    ...
    public CrustConfigFileScreen( Screen parent, CrustConfigSpec spec, boolean remote, boolean editable ) {
        super( Component.translatable( "menu.crust.config.file.title",
                ConfigUtil.getModName( spec.MANAGER.MOD_ID ), ConfigUtil.getSpecName( spec ) ) );
        LAST_SCREEN = parent;
        SPEC = spec;
    ...
    public void setPopupWidget( @Nullable AbstractWidget popup ) {
        popupWidget = popup;
        if( popup instanceof IPopupWidget pop ) pop.init();
    }
    ...
    public void resetScreen() {
        if( minecraft != null ) {
            CrustConfigFileScreen newScreen = new CrustConfigFileScreen( LAST_SCREEN, SPEC, REMOTE, EDITABLE );
            minecraft.setScreen( newScreen );
            newScreen.setScrollAmount( getScrollAmount() );
        }
    }
    
    /** Called to clear all widgets from the screen. */
    @Override
    ...
    protected void init() {
        ...
        fieldList = new CrustConfigFieldList( this, minecraft, SPEC, REMOTE, EDITABLE );
        ...
        searchbar = Searchbar.create( this, fieldList, orientation.getOpposite(),
