...
public class ClientRegister {
    ...
    public static final CfgEditorCrustConfigFile CFG_EDIT_BUTTON = new CfgEditorCrustConfigFile(
            ConfigManager.getRequired( Crust.MOD_ID ), "client_ingame_edit_button" );
    ...
    static void onClientSetup( FMLClientSetupEvent event ) {
        ...
        CFG_EDIT_BUTTON.SPEC.initialize();
        EXTRA_INV_BUTTONS.SPEC.initialize();
        
        // Tell Forge to open the config edit screen when our mod's "Config" button is clicked in the Mods screen
