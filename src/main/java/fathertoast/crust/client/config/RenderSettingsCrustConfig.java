...
public class RenderSettingsCrustConfig extends AbstractConfigFile {
    ...
    public final RenderSettingsCrustConfig.BlockEntityBBRendering BLOCK_ENTITY_BB_RENDERING;
    ...
    public RenderSettingsCrustConfig( ConfigManager cfgManager, String cfgName ) {
        ...
        BLOCK_ENTITY_BB_RENDERING = new RenderSettingsCrustConfig.BlockEntityBBRendering( this, "block_entity_BB_rendering",
    ...
    public static class BlockEntityBBRendering extends AbstractConfigCategory<RenderSettingsCrustConfig> {
        ...
        BlockEntityBBRendering( RenderSettingsCrustConfig parent, String category, String categoryDescription ) {
