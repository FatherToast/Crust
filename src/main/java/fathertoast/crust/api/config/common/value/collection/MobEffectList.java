...
import fathertoast.crust.api.config.common.field.collection.MobEffectListField;
...
public class MobEffectList extends RegistryValueList<MobEffect, MobEffectStats> {
    ...
    @Nullable
    public static MobEffectInstance toInstance( @Nullable Pair<MobEffect, MobEffectStats> pair ) {
