...
public class CrustConfigFormat implements ConfigFormat<CommentedConfig> {
    ...
    CrustConfigFormat( CrustConfigSpec spec ) { CONFIG_SPEC = spec; }
    
    /** @return A writer of this config format. */
    @Override
    public ConfigWriter createWriter() { return new CrustTomlWriter( CONFIG_SPEC ); }
    
    /** @return A parser of this config format. */
    @Override
    public ConfigParser<CommentedConfig> createParser() { return new CrustTomlParser( CONFIG_SPEC ); }
