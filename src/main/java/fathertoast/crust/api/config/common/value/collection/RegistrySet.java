...
public class RegistrySet<T> extends FuzzySet<T> {
    ...
    public static class Builder<T, B extends Builder<T, B>> extends AbstractBuilder<T, RegistrySet<T>, B> {
        ...
        public B addBlacklist( ResourceLocation resLoc ) { return add( RegObjKey.Basic.of( registry, resLoc, true ) ); }
        ...
        public B addBlacklist( RegistryObject<? extends T> regObj ) { return add( RegObjKey.Basic.of( registry, regObj, true ) ); }
        ...
        public B addBlacklist( T obj ) { return add( RegObjKey.Basic.of( registry, obj, true ) ); }
        ...
        public B addWildcard( ResourceLocation partialResLoc ) { return add( RegObjKey.Wildcard.of( registry, partialResLoc, false ) ); }
        ...
        public B addWildcardBlacklist( ResourceLocation partialResLoc ) { return add( RegObjKey.Wildcard.of( registry, partialResLoc, true ) ); }
        ...
        public B addWildcard( String namespace, String partialPath ) { return add( RegObjKey.Wildcard.of( registry, namespace, partialPath, false ) ); }
        ...
        public B addWildcardBlacklist( String namespace, String partialPath ) { return add( RegObjKey.Wildcard.of( registry, namespace, partialPath, true ) ); }
        ...
        public B addTagBlacklist( ResourceLocation resLoc ) { return add( RegObjKey.Tag.of( registry, resLoc, true ) ); }
        ...
        public B addTagBlacklist( TagKey<T> tag ) { return add( RegObjKey.Tag.of( registry, tag, true ) ); }
    }
}